---
title: "H3K4Me3 K562 track from UCSC table browser"
author: "Paul Shannon"
package: igvR
date: "`r Sys.Date()`"
output:
...
vignette: >
  %\VignetteIndexEntry{"H3K4Me3 K562 track from UCSC table browser")
...
The UCSC Table Browser can be a good source of genomic annotations of many different kinds.
It has a clear, easily navigated user interface, and is a good complement to igvR.

Here we obtain H3K4Me3 methylation marks in K562 cells in and around GATA2.  The H3K4Me3
post-translational modification is frequently found in active promoters near transcription
start sites.
...
7. back in R, use read.table on that file
