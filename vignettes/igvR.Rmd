---
title: "igvR: programmatic access to the web browser-based genome track viewer, igv.js"
author: "Paul Shannon"
package: igvR
date: "`r Sys.Date()`"
output:
...
The igvR package provides easy programmit access in R to the web-based javascript library
...
We will proceed as follows:
 ...
 - employ Bioconductor's AnnotationHub to retrieve three methylation datasets; these are associated
    ...
    With each of these datasets we create an igvR track (of an approriate type - igvR's Track class
...
```{r createLoad, eval=FALSE, results='hide'}
igv <- igvR()
